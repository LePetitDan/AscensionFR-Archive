...
-- de <joueur> et Dan : plus la mémoire vive du jeu est grosse, plus son
...
AFR.DB = {
    ...
    SortsLignes = {},   -- [spellID]    = fiche communautaire (motifs {{n}})
    ...
    Guichets    = {},   -- [texteEN]    = texteFR   (courrier MailTemplate,
                        --                           factions, fêtes : DBC
                        --                           officiel frFR par ID)
